...
- `__adjacent_gap_inference.csv`: all five adjacent pairs with the classical
  FPCA simple-root Wald interval, general repeated-root p-value, Anderson
  Gaussian p-value, and Proposed symmetric-gap inference.
- `__prespecified_candidate_cluster_inference.csv`: only the nonoverlapping
  candidate pairs fixed before inspecting equality-test nonrejection.
