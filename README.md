...
This experiment uses the same grid and decay as Experiment 3A but changes the
...
`decay=1.1`, `M=3`, and respective replication counts `2000,1500,1000`.
